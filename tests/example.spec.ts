...
test.describe('CPRWebTest', () => {
  ...
  test('申请种子页面用例', async ({ page }) => {
    ...
    // 访问申请种子页面
    await page.goto('http://127.0.0.1:18080/cprweb/oa/supply-request/create/');
  ...
  test('申请列表页面用例', async ({ page }) => {
    ...
    // 访问申请列表页面
    await page.goto('http://127.0.0.1:18080/cprweb/oa/supply-requests/');
  ...
  test('待审批请求页面用例', async ({ page }) => {
    ...
    // 访问待审批请求页面
    await page.goto('http://127.0.0.1:18080/cprweb/oa/pending-approvals/');
